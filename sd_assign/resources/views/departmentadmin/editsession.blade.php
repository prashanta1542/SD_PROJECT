...
<div style="background-color:aquamarine;height:100vh">
   ...
   <div class="container">
        ...
        @endif
        <form method="post" action="{{url('updatesession/'.$s->id)}}">
            @csrf

            <div class="form-group">
                <label for="year">Year Of Session:</label>
                <input type="text" class="form-control" placeholder="Write the session year" id="name" value="{{$s->year}}" name="year">
            </div>
            <div class="form-group">
                <label for="batch">Batch No:</label>
                <input type="text" class="form-control" placeholder="Enter Batch" id="aliases" value="{{$s->batch}}" name="batch">
            </div>
            <div class="form-group">
